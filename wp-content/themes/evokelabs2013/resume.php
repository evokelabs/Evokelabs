...
/*
Template Name: Evokelabs Resume
*/
                    ...
                    <div class="HR-resume"></div>
                        <div id="aboutdesc-resume">
                             ...
                             <div id="aboutdesc-brief-resume-left">
                                ...
                                <p>I excel in digital hybrid roles and am particularly focused on furthering my skills in frontend technologies and VR/AR.</p>
                             </div>
...
<div class="HR-resume"></div> 
            ...
            <ul>
                ...
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients4.gif" alt ="Microsoft" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients5.gif" alt ="News Limited" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients6.gif" alt ="Woolworths" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients7.gif" alt ="Westfield" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients8.gif" alt ="Pfizer" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients9.gif" alt ="Career One" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients10.gif" alt ="Aperol" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients11.gif" alt ="Donut King" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients12.gif" alt ="Frangelico" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients13.gif" alt ="Helga's Bakehouse" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients14.gif" alt ="Michel's Patisserie" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients15.gif" alt ="Mr Men." /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients16.gif" alt ="Rams Homeloans" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients17.gif" alt ="Skyy Vodka" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients18.gif" alt ="Wattyl Paints" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients19.gif" alt ="Wild Turkey" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients20.gif" alt ="Bupa" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients21.gif" alt ="Renault" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Clients22.gif" alt ="Jetstar" /></li>
            ...
            <ul>
                ...
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Agency4.gif" alt ="Wunderman" /></li>
                <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Agency5.gif" alt ="Tectonic Digital" /></li>
           ...
           <div class="darkerBG">
            <div class="casestudy-resume">
                ...
                <div id="skills-resume">

                <div id="skills-resume-left">
                ...
                <ul>
                    ...
                    <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Interests1.gif" alt ="Fitness" /></li>
                    <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Interests2.gif" alt ="YouTube" /></li>
                    <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Interests3.gif" alt ="Kindle" /></li>
                    <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Interests4.gif" alt ="Toastmasters International" /></li>
                    <li><img src="<?php bloginfo('template_url'); ?>/../../../img/resume/Interests6.gif" alt ="Motorbikes" /></li>
