...
<meta name="author" content="EVOKE LABS" /> 
 ...
 <script type="text/javascript">
  ...
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/evokelabs.css" type="text/css"> 
  <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/magnific-popup.css" type="text/css"> 

 <!--[if IE]>

 <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/css/evokelabsIE.css" type="text/css"> 
